...
```sh
pip install git+https://github.com/In-For-Disaster-Analytics/upstream-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/In-For-Disaster-Analytics/upstream-client.git`)
